...
const mostrarInfo = (materia) =>{
	...
	if (info !== false){
		...
		let alumnos = info[0];
		alumnos.shift();
		document.write(`El profesor de ${info[1]} es ${profesor} y sus alumnos son ${alumnos} <br><br>`)
		}		
...
const claseAlumno = (alumno) =>{
	...
	return `${alumno} esta en ${cantidad} clases. Esta cursando las clases: ${clasesPresentes} <br>`;
}
